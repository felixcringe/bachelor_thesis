\documentclass[Bachelor, Submit, UKenglish]{scrbook}
%------------------------------------------------------------------------------
...
\newcommand{\thesistitle}{Information content of ZDR-columns for nowcasting}
\newcommand*{\thesisauthor}{Felix Crijnen}
\newcommand*{\thesistown}{St. Michel}
\renewcommand*{\InstituteName}{Meteorologisches Institut} %\PI
\renewcommand*{\inInstitute}{im Meteorologischen Institut}   %\inPI
\renewcommand*{\InstituteAddress}{Institut für Geowissenschaften, Abt. Meteorologie der\\
	Universität Bonn\\
	Auf dem Hügel 20\\
	D-53121 Bonn}  %\PIaddress
% Adjust \thesisreferee...text depending on male/female referee
\newcommand*{\thesisrefereeonetext}{Referee}
\newcommand*{\thesisrefereeone}{PD Dr.\ Silke Trömel}
\newcommand*{\thesisrefereetwotext}{Co-Referee}
\newcommand*{\thesisrefereetwo}{Prof.\ Dr.\ Herbert Dreiner}
% Date when thesis was submitted (Master/Diplom)
% Year or Month, Year when thesis was submitted (PhD)
\newcommand*{\thesissubmit}{14.06.2021}
